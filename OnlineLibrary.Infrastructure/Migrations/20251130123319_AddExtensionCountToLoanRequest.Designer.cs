...
namespace OnlineLibrary.Infrastructure.Migrations
{
    ...
    [Migration("20251130123319_AddExtensionCountToLoanRequest")]
    partial class AddExtensionCountToLoanRequest
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OnlineLibrary.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("EmailOtpExpiry")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTimeOffset?>("PasswordResetOtpExpiry")
                        .HasColumnType("timestamp with time zone");
